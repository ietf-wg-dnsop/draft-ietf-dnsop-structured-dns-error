...
l: (language)
: The "lang" field indicates the language used for the JSON-encoded "j" and "o" fields  and MUST conform to the
  language tag syntax specified in {{!RFC5646}}.
...
| l | language     | Indicates the language of the "j" and "o" fields as defined in RFC 5646 | No | {{name-spec}} of RFCXXXX |
